...
def mineTree(inTree, headerTable, minSup, preFix, freqItemList):
    ...
    bigL = [v[0] for v in sorted(headerTable.items(), key=lambda p: str(p[1]))]  # String
...
if __name__ == '__main__':
    ...
    parsedDat = [line.split() for line in open('/home/arlen/Files/python/FinalTask/data/newsread.dat').readlines()]
